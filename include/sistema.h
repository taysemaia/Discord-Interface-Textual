...
class Sistema {
  ...
  public:
	...
	*/
  	bool buscaNomeServidor(std::string nome);
	...
	*/
  	void adicionarAosLogados(int idLogado);
	...
	*/
  	bool buscaSenhaEmail(std::string senha, std::string email);
